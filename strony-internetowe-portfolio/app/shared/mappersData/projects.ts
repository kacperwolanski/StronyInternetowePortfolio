...
export const projects: Project[] = [
...

  {
    ...
    title: "Strona CV/Portfolio",
    description:
      "Projekt eleganckiej i estetycznej strony internetowej CV/Portfolio. Stronę wyróżnia przejrzysty i nowoczesny design, który samodzielnie zaprojektowałem w Figmie.",
    linkToProject: "https://kacperwolanski.github.io/myPortfolio/",
  },
  {
    desktopImage:
      "https://github.com/user-attachments/assets/b93ae94c-4380-4d31-92cd-4c4b3b1f9643",
    title: "Strona doradcy motoryzacyjnego",
    description:
      "Strona internetowa dla KiliAuto – firmy specjalizującej się w doradztwie przy zakupie używanych samochodów i motocykli. Optymalizacja SEO, którą przeprowadziłem, przyczyniła się do 45% wzrostu liczby pozyskiwanych klientów miesięcznie. Na stronie znajdują się również ogłoszenia sprzedaży sprawdzonych używanych motocykli.",
    linkToProject: "https://kiliauto.pl/",
  },
];
